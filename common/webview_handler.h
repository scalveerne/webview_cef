...
public:
    ...
    void pauseBrowser(int browserId, bool pause);
...
private:
    ...
    std::map<std::string, CefRefPtr<CefRequestContext>> profile_contexts_;
    CefRefPtr<CefRequestContext> GetRequestContextForProfile(const std::string &profileId);
};
